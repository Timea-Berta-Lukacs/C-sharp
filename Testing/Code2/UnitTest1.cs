...
namespace BankFeatures
{
    ...
    public class AccountTests
    {
        ...
        {
            // Arrange
            Account sourceAccount = new Account(InitValue, "John"); // Cont sursă cu 1000 Lei
            Account destinationAccount = new Account(InitValue, "Mary"); // Cont destinație cu 500 Lei

            // Utilizăm stub-ul pentru conversie valutară
            ICurrencyConvertor convertor = new CurrencyConvertorStub();
